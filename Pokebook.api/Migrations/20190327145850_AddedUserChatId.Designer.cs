...
namespace Pokebook.api.Migrations
{
    ...
    [Migration("20190327145850_AddedUserChatId")]
    partial class AddedUserChatId
    {
            ...
            modelBuilder.Entity("Pokebook.api.Models.Chat", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("00000000-0000-0000-0000-000000000001"), CreateDate = new DateTime(2019, 3, 27, 15, 58, 50, 478, DateTimeKind.Local), CreatorId = new Guid("00000000-0000-0000-0000-000000000000"), Name = "Awesome Chat", NumberOfMessages = 0, NumberOfUsers = 0 },
                        new { Id = new Guid("00000000-0000-0000-0000-000000000002"), CreateDate = new DateTime(2019, 3, 27, 13, 58, 50, 480, DateTimeKind.Local), CreatorId = new Guid("00000000-0000-0000-0000-000000000000"), Name = "Another awesome Chat", NumberOfMessages = 0, NumberOfUsers = 0 }
                    );
                });
            ...
            modelBuilder.Entity("Pokebook.api.Models.UserChat", b =>
                {
                    ...
                    b.HasData(
                        new { ChatId = new Guid("00000000-0000-0000-0000-000000000001"), UserId = new Guid("00000000-0000-0000-0000-000000000001"), Id = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { ChatId = new Guid("00000000-0000-0000-0000-000000000002"), UserId = new Guid("00000000-0000-0000-0000-000000000002"), Id = new Guid("00000000-0000-0000-0000-000000000000") },
                        new { ChatId = new Guid("00000000-0000-0000-0000-000000000002"), UserId = new Guid("00000000-0000-0000-0000-000000000001"), Id = new Guid("00000000-0000-0000-0000-000000000000") }
                    );
                });
